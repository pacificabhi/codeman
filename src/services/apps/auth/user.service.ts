...
import UserToken, { IUserToken } from '../../../models/apps/auth/user.token.model'
...
const generateUsername = async (email: string, firstname: string, lastname: string) => {
...
const verifyJwtToken = (token: string): Object => {
